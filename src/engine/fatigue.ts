...
export const BASE_SNAP_COSTS: Record<FatigueTrackedPosition, Record<PlayType, number>> = {
  QB: { INSIDE_ZONE: 1, OUTSIDE_ZONE: 1, POWER: 1, QUICK_GAME: 2, DROPBACK: 3, SCREEN: 2, RUN: 1, SHORT_PASS: 2, DEEP_PASS: 3, PLAY_ACTION: 2, SPIKE: 1, KNEEL: 1, PUNT: 0, FG: 0, RPO_READ: 2, QB_KEEP: 1 },
  RB: { INSIDE_ZONE: 4, OUTSIDE_ZONE: 4, POWER: 5, QUICK_GAME: 2, DROPBACK: 1, SCREEN: 3, RUN: 4, SHORT_PASS: 1, DEEP_PASS: 1, PLAY_ACTION: 3, SPIKE: 0, KNEEL: 1, PUNT: 0, FG: 0, RPO_READ: 3, QB_KEEP: 2 },
  WR: { INSIDE_ZONE: 2, OUTSIDE_ZONE: 2, POWER: 2, QUICK_GAME: 3, DROPBACK: 4, SCREEN: 3, RUN: 2, SHORT_PASS: 3, DEEP_PASS: 4, PLAY_ACTION: 4, SPIKE: 0, KNEEL: 0, PUNT: 0, FG: 0, RPO_READ: 3, QB_KEEP: 2 },
  TE: { INSIDE_ZONE: 3, OUTSIDE_ZONE: 3, POWER: 3, QUICK_GAME: 2, DROPBACK: 3, SCREEN: 2, RUN: 3, SHORT_PASS: 2, DEEP_PASS: 3, PLAY_ACTION: 3, SPIKE: 0, KNEEL: 0, PUNT: 0, FG: 0, RPO_READ: 2, QB_KEEP: 2 },
  OL: { INSIDE_ZONE: 3, OUTSIDE_ZONE: 3, POWER: 4, QUICK_GAME: 3, DROPBACK: 4, SCREEN: 3, RUN: 3, SHORT_PASS: 3, DEEP_PASS: 4, PLAY_ACTION: 4, SPIKE: 1, KNEEL: 2, PUNT: 0, FG: 0, RPO_READ: 3, QB_KEEP: 3 },
  DL: { INSIDE_ZONE: 3, OUTSIDE_ZONE: 3, POWER: 4, QUICK_GAME: 2, DROPBACK: 3, SCREEN: 2, RUN: 3, SHORT_PASS: 2, DEEP_PASS: 3, PLAY_ACTION: 3, SPIKE: 0, KNEEL: 1, PUNT: 0, FG: 0, RPO_READ: 2, QB_KEEP: 2 },
  LB: { INSIDE_ZONE: 3, OUTSIDE_ZONE: 3, POWER: 4, QUICK_GAME: 2, DROPBACK: 2, SCREEN: 2, RUN: 3, SHORT_PASS: 2, DEEP_PASS: 2, PLAY_ACTION: 3, SPIKE: 0, KNEEL: 1, PUNT: 0, FG: 0, RPO_READ: 2, QB_KEEP: 2 },
  DB: { INSIDE_ZONE: 2, OUTSIDE_ZONE: 3, POWER: 3, QUICK_GAME: 3, DROPBACK: 3, SCREEN: 2, RUN: 2, SHORT_PASS: 3, DEEP_PASS: 4, PLAY_ACTION: 3, SPIKE: 0, KNEEL: 0, PUNT: 0, FG: 0, RPO_READ: 2, QB_KEEP: 1 },
};
