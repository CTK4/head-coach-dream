      ...
      {activeTab === "SHORTLIST" ? (
        <div className="space-y-2">
          {shortlist.map((prospect) => {
            ...
            const charReveal = prospect.profile.clarity.CHAR ?? 0;
            const iqReveal = prospect.profile.clarity.FIT ?? 0;
            ...
            const charRange = formatRange(trueCharacterScore, charReveal);
            const iqRange = formatRange(trueIntelligenceScore, iqReveal);
