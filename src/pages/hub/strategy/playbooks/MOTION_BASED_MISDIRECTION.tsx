...
const PLAYS = [
  /* ═══ RUNS 1-15 ══════════════════════════════ */
  {
    id:1, name:'JetSweep', label:'Jet Sweep', cat:'run',
    sk:[
  ...
  {
    id:2, name:'OrbitSweep', label:'Orbit Sweep', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
  ...
  {
    id:3, name:'CounterJet', label:'Counter Jet', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
  ...
  {
    id:4, name:'SplitZoneMotion', label:'Split Zone Motion', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:118,y:LOS,t:'H'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      {d:CB([26,LOS],[50,LOS+12],[82,LOS+10],[110,LOS+2]), c:CLR.motion,w:1.4,a:false,dsh:true},
  ...
  {
    id:5, name:'DuoMotion', label:'Duo Motion', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      {d:CB([26,LOS],[50,LOS+12],[84,LOS+10],[116,LOS+2]), c:CLR.motion,w:1.4,a:false,dsh:true},
  ...
  {
    id:6, name:'PinPullMotion', label:'Pin-Pull Motion', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([180,LOS],[154,LOS+14],[126,LOS+12],[106,LOS+4]), c:CLR.motion,w:1.4,a:false,dsh:true},
  ...
  {
    id:7, name:'TossOrbit', label:'Toss Orbit', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([180,LOS],[170,LOS+16],[132,QB_Y+10],[96,QB_Y+2]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:QQ([88,QB_Y],[124,QB_Y-2],[152,86]), c:CLR.toss,w:1.3,a:true,dsh:true},
      {d:CB([152,86],[168,60],[182,42],[192,28]), c:CLR.run,w:2.8,a:true},
      {d:P([70,LOS],[82,LOS-5]),  c:CLR.block,w:1.2,a:true},
      {d:P([80,LOS],[94,LOS-5]),  c:CLR.block,w:1.2,a:true},
      {d:P([90,LOS],[106,LOS-5]), c:CLR.block,w:1.2,a:true},
      {d:P([100,LOS],[118,LOS-5]),c:CLR.block,w:1.2,a:true},
      {d:P([110,LOS],[130,LOS-5]),c:CLR.block,w:1.2,a:true},
    ],
  },
  {
    id:8, name:'TrapMotion', label:'Trap Motion', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      {d:CB([26,LOS],[50,LOS+12],[82,LOS+10],[112,LOS+2]), c:CLR.motion,w:1.4,a:false,dsh:true},
  ...
  {
    id:9, name:'StretchMotion', label:'Stretch Motion', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([26,LOS],[50,LOS+12],[84,LOS+10],[116,LOS+2]), c:CLR.motion,w:1.4,a:false,dsh:true},
      {d:CB([102,QB_Y],[108,84],[126,68],[150,50]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:10, name:'CounterBash', label:'Counter Bash', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
  ...
  {
    id:11, name:'JetPower', label:'Jet Power', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([6,LOS],[30,LOS+14],[70,LOS+16],[116,LOS+2]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:P([88,QB_Y],[104,QB_Y-6]), c:CLR.toss,w:1.2,a:true,dsh:true},
      {d:CB([116,LOS+2],[132,62],[148,54],[162,48]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:12, name:'Reverse', label:'Reverse', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([6,LOS],[30,LOS+14],[70,LOS+16],[112,LOS+4]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:P([88,QB_Y],[104,QB_Y-6]), c:CLR.toss,w:1.2,a:true,dsh:true},
      {d:QQ([112,LOS+4],[128,LOS+18],[152,LOS+12]), c:CLR.toss,w:1.2,a:true,dsh:true},
      {d:CB([152,LOS+12],[130,60],[96,44],[62,34]), c:CLR.run,w:2.8,a:true},
      {d:P([162,LOS],[154,LOS-8]), c:CLR.block,w:1.2,a:true},
      {d:P([180,LOS],[170,LOS-8]), c:CLR.block,w:1.2,a:true},
      {d:P([70,LOS],[82,LOS-6]),   c:CLR.block,w:1.2,a:true},
      {d:P([80,LOS],[92,LOS-6]),   c:CLR.block,w:1.2,a:true},
    ],
  },
  {
    id:13, name:'SweepRead', label:'Sweep Read', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
  ...
  {
    id:14, name:'MotionTossCrack', label:'Motion Toss Crack', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      ...
      {d:CB([162,LOS],[150,56],[136,50],[122,50]), c:CLR.block,w:1.5,a:true},
      {d:P([70,LOS],[82,LOS-5]),  c:CLR.block,w:1.2,a:true},
      {d:P([80,LOS],[94,LOS-5]),  c:CLR.block,w:1.2,a:true},
      {d:P([90,LOS],[106,LOS-5]), c:CLR.block,w:1.2,a:true},
      {d:P([100,LOS],[118,LOS-5]),c:CLR.block,w:1.2,a:true},
  ...
  {
    id:15, name:'JetDuo', label:'Jet Duo', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:88,y:QB_Y+12,t:'RB'},
  ...
  /* ═══ PASS 16-30 ═════════════════════════════ */
  {
    id:16, name:'JetPAOver', label:'Jet Play-Action Over', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([6,LOS],[30,LOS+14],[70,LOS+16],[116,LOS+2]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:CB([102,QB_Y],[98,84],[94,76],[92,70]), c:CLR.run,w:2,a:true,dsh:true},
      {d:CB([162,LOS],[144,44],[116,36],[78,34]), c:CLR.pass,w:2.4,a:true},
      {d:P([180,LOS],[180,20]), c:CLR.pass,w:1.8,a:true},
      {d:P([26,LOS],[26,24]), c:CLR.pass,w:1.6,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:17, name:'OrbitFlood', label:'Orbit Flood', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
    ...
    rt:[
      {d:CB([180,LOS],[170,LOS+16],[132,QB_Y+10],[96,QB_Y+2]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:P([162,LOS],[162,22]), c:CLR.pass,w:2.2,a:true},
      {d:CB([96,QB_Y+2],[122,70],[150,56],[180,50]), c:CLR.pass,w:2.2,a:true},
      {d:QQ([26,LOS],[44,66],[64,64]), c:CLR.pass,w:2,a:true},
      {d:P([6,LOS],[6,28]), c:CLR.pass,w:1.5,a:true},
      {d:P([88,QB_Y],[96,QB_Y+6]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:18, name:'BootCross', label:'Boot Cross', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:118,y:LOS,t:'H'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      ...
      {d:CB([118,LOS],[130,50],[148,40],[176,36]), c:CLR.pass,w:2.4,a:true},
      {d:P([180,LOS],[180,20]), c:CLR.pass,w:2.2,a:true},
      {d:P([162,LOS],[162,24]), c:CLR.pass,w:1.6,a:true},
      {d:P([6,LOS],[6,24]), c:CLR.pass,w:1.5,a:true},
    ],
  },
  {
    id:19, name:'DaggerMotion', label:'Dagger Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  {
    id:20, name:'MeshMotion', label:'Mesh Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:100,y:QB_Y,t:'RB'},
  ...
  {
    id:21, name:'SlotFadeMotion', label:'Slot Fade Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  {
    id:22, name:'DriveMotion', label:'Drive Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:100,y:QB_Y,t:'RB'},
  ...
  {
    id:23, name:'LevelsMotion', label:'Levels Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  {
    id:24, name:'SwitchVertMotion', label:'Switch Vert Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  {
    id:25, name:'SailMotion', label:'Sail Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:100,y:LOS,t:'TE'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
  ...
  {
    id:26, name:'ShallowMotion', label:'Shallow Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  {
    id:27, name:'FloodMotion', label:'Flood Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:100,y:LOS,t:'TE'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
  ...
  {
    id:28, name:'PostWheelMotion', label:'Post-Wheel Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      ...
      {d:CB([102,QB_Y],[120,QB_Y],[148,80],[168,28]), c:CLR.pass,w:2.2,a:true},
  ...
  {
    id:29, name:'QuickOutMotion', label:'Quick Out Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  {
    id:30, name:'DeepOverMotion', label:'Deep Over Motion', cat:'pass',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
    ...
    rt:[
      {d:CB([6,LOS],[30,LOS+14],[70,LOS+16],[116,LOS+2]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:CB([162,LOS],[144,44],[116,34],[72,28]), c:CLR.pass,w:2.4,a:true},
      {d:P([180,LOS],[180,20]), c:CLR.pass,w:2.2,a:true},
      {d:P([26,LOS],[26,24]), c:CLR.pass,w:1.6,a:true},
      {d:P([6,LOS],[6,24]), c:CLR.pass,w:1.6,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  ...
  /* ═══ PLAY ACTION 31-35 ══════════════════════ */
  {
    id:31, name:'JetPAPost', label:'Jet PA Post', cat:'pa',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([6,LOS],[30,LOS+14],[70,LOS+16],[116,LOS+2]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:CB([102,QB_Y],[98,84],[94,76],[92,70]), c:CLR.run,w:2,a:true,dsh:true},
      {d:CB([180,LOS],[180,36],[162,24],[142,18]), c:CLR.pa,w:2.2,a:true},
      {d:CB([26,LOS],[26,36],[44,24],[64,18]), c:CLR.pa,w:2.2,a:true},
      {d:P([162,LOS],[162,24]), c:CLR.pa,w:1.6,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:32, name:'OrbitPACross', label:'Orbit PA Cross', cat:'pa',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([180,LOS],[170,LOS+16],[132,QB_Y+10],[96,QB_Y+2]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:CB([102,QB_Y],[98,84],[94,76],[92,70]), c:CLR.run,w:2,a:true,dsh:true},
      {d:CB([162,LOS],[144,44],[116,36],[78,34]), c:CLR.pa,w:2.4,a:true},
      {d:P([26,LOS],[26,22]), c:CLR.pa,w:2.2,a:true},
      {d:P([6,LOS],[6,24]), c:CLR.pa,w:1.6,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:33, name:'BootShot', label:'Boot Shot', cat:'pa',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:118,y:LOS,t:'H'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      ...
      {d:CB([102,QB_Y],[98,84],[94,76],[92,70]), c:CLR.run,w:2,a:true,dsh:true},
      {d:QQ([88,QB_Y],[110,QB_Y+8],[128,86]), c:CLR.qbmove,w:1.8,a:false,dsh:true},
      {d:CB([180,LOS],[194,36],[178,14],[160,12]), c:CLR.pa,w:2.5,a:true},
      {d:CB([162,LOS],[162,32],[136,18],[112,16]), c:CLR.pa,w:2.5,a:true},
      {d:QQ([118,LOS],[136,66],[154,64]), c:CLR.pa,w:2.2,a:true},
    ],
  },
  {
    id:34, name:'Leak', label:'Leak', cat:'pa',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:100,y:LOS,t:'TE'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      {d:CB([180,LOS],[154,LOS+14],[126,LOS+12],[106,LOS+4]), c:CLR.motion,w:1.4,a:false,dsh:true},
      {d:CB([102,QB_Y],[98,84],[94,76],[92,70]), c:CLR.run,w:2,a:true,dsh:true},
      {d:P([100,LOS],[100,LOS-2]), c:CLR.protect,w:1.5,a:false},
      {d:CB([100,LOS-2],[116,60],[136,62],[156,62]), c:CLR.pa,w:2.4,a:true},
      {d:P([180,LOS],[180,20]), c:CLR.pa,w:2.2,a:true},
      {d:P([162,LOS],[162,24]), c:CLR.pa,w:1.6,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:35, name:'ReversePass', label:'Reverse Pass', cat:'pa',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
    ...
    rt:[
      ...
      {d:P([88,QB_Y],[104,QB_Y-6]), c:CLR.toss,w:1.2,a:true,dsh:true},
      {d:QQ([112,LOS+4],[128,LOS+18],[152,LOS+12]), c:CLR.toss,w:1.2,a:true,dsh:true},
      {d:CB([152,LOS+12],[152,48],[138,24],[120,14]), c:CLR.pa,w:2.5,a:true},
      {d:CB([180,LOS],[190,34],[176,18],[158,12]), c:CLR.pa,w:2.2,a:true},
      {d:P([162,LOS],[162,22]), c:CLR.pa,w:1.8,a:true},
      {d:P([26,LOS],[26,22]), c:CLR.pa,w:1.8,a:true},
    ],
  },

  /* ═══ SCREENS 36-40 ══════════════════════════ */
  {
    id:36, name:'TunnelMotion', label:'Tunnel Motion', cat:'screen',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([180,LOS],[154,LOS+14],[126,LOS+12],[106,LOS+4]), c:CLR.motion,w:1.4,a:false,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+6]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([162,LOS],[166,70],[170,78],[172,82]), c:CLR.screen,w:2.2,a:true},
      {d:CB([88,QB_Y+6],[118,86],[148,84],[172,82]), c:CLR.screen,w:1.8,a:true,dsh:true},
      {d:CB([180,LOS],[176,68],[172,74],[168,78]), c:CLR.block,w:1.5,a:true},
      {d:CB([110,LOS],[128,64],[148,60],[160,62]), c:CLR.block,w:1.5,a:true},
      {d:P([6,LOS],[6,26]), c:CLR.pass,w:1,a:true,dsh:true},
    ],
  },
  {
    id:37, name:'BubbleMotion', label:'Bubble Motion', cat:'screen',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
    ...
    rt:[
      ...
      {d:QQ([180,LOS],[166,72],[154,78]), c:CLR.screen,w:1.5,a:true},
      {d:CB([88,QB_Y],[110,80],[124,78],[136,78]), c:CLR.screen,w:1.6,a:true,dsh:true},
      {d:P([6,LOS],[6,24]), c:CLR.pass,w:1.2,a:true},
      {d:P([26,LOS],[26,24]), c:CLR.pass,w:1.2,a:true},
    ],
  },
  {
    id:38, name:'SlipMotion', label:'Slip Motion', cat:'screen',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:100,y:LOS,t:'TE'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      {d:CB([26,LOS],[50,LOS+12],[82,LOS+10],[112,LOS+2]), c:CLR.motion,w:1.4,a:false,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([100,LOS],[100,LOS-2],[108,64],[122,72]), c:CLR.screen,w:2.2,a:true},
      {d:CB([88,QB_Y+8],[98,78],[108,74],[122,72]), c:CLR.screen,w:1.8,a:true,dsh:true},
      {d:CB([70,LOS],[82,64],[96,62],[108,64]), c:CLR.block,w:1.5,a:true},
      {d:CB([80,LOS],[92,66],[106,64],[118,66]), c:CLR.block,w:1.5,a:true},
      {d:P([162,LOS],[162,24]), c:CLR.pass,w:1,a:true,dsh:true},
    ],
  },
  {
    id:39, name:'SwingMotion', label:'Swing Motion', cat:'screen',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      {d:CB([180,LOS],[154,LOS+14],[126,LOS+12],[106,LOS+4]), c:CLR.motion,w:1.4,a:false,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([104,QB_Y],[136,QB_Y],[164,76],[174,70]), c:CLR.screen,w:2.2,a:true},
  ...
  {
    id:40, name:'TEDelay', label:'TE Delay', cat:'screen',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:100,y:LOS,t:'TE'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
    ...
    rt:[
      ...
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:P([100,LOS],[100,LOS-2]), c:CLR.protect,w:1.5,a:false},
      {d:CB([100,LOS-2],[102,62],[108,72],[120,78]), c:CLR.screen,w:2.2,a:true},
      {d:CB([70,LOS],[80,66],[94,68],[108,72]), c:CLR.block,w:1.5,a:true},
      {d:CB([80,LOS],[92,68],[106,70],[118,74]), c:CLR.block,w:1.5,a:true},
      {d:P([162,LOS],[162,24]), c:CLR.pass,w:1,a:true,dsh:true},
...
/* ── LEGENDS ─────────────────────────────────── */
const LEGENDS = {
  run:    [{c:CLR.run,l:'Ball Carrier'},{c:CLR.motion,l:'Motion'},{c:CLR.read,l:'Read'},{c:CLR.pull,l:'Pull'},{c:CLR.toss,l:'Pitch'},{c:CLR.block,l:'Block'}],
  pass:   [{c:CLR.pass,l:'Route'},{c:CLR.motion,l:'Motion'},{c:CLR.qbmove,l:'QB Move'}],
  pa:     [{c:CLR.run,l:'Run Fake'},{c:CLR.motion,l:'Motion'},{c:CLR.pa,l:'PA Route'},{c:CLR.qbmove,l:'Boot/Set'},{c:CLR.protect,l:'Protect'}],
  screen: [{c:CLR.screen,l:'Screen'},{c:CLR.motion,l:'Motion'},{c:CLR.block,l:'Escort'},{c:CLR.qbmove,l:'Set'}],
};
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding: '12px 16px 14px', borderTop: `1px solid ${meta.accent}20` }}>
          ...
          <div style={{ display:'flex', flexWrap:'wrap', gap:'6px 14px', marginBottom:8 }}>
            {[['WR','#a78bfa'],['TE','#34d399'],['QB','#fbbf24'],['RB','#f87171'],['H','#f472b6'],['OL','#8b9ab5']].map(([t,c]) => (
...
/* ── APP ─────────────────────────────────────── */
export default function MotionBasedMisdirectionPlaybook() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
          ...
          <div>
            ...
            <div style={{ color:'#f472b6', fontSize:9, fontWeight:700, letterSpacing:'3px', opacity:0.8 }}>
              PRE-SNAP STRESS · EYE CANDY · LEVERAGE CREATION
            </div>
          </div>
      ...
      <div style={{
        ...
        MOTION-BASED / MISDIRECTION OFFENSE · 40 PLAYS · TAP TO DETAIL
      </div>
