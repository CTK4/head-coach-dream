...
const PLAYS = [
  /* ═══ RUNS 1-15 ══════════════════════════════ */
  {
    ...
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[88,96],[88,76],[88,50]), c:CLR.run, w:2.8,a:true},
  ...
  },
  {
    ...
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[88,96],[88,76],[88,48]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:3, name:'Iso', label:'Iso', cat:'run',
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[88,96],[88,78],[88,48]), c:CLR.run,w:2.8,a:true},
      {d:P([88,FB_Y],[88,70]),                  c:CLR.block,w:1.8,a:true},
  ...
  {
    id:4, name:'SplitZone', label:'Split Zone', cat:'run',
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[88,96],[82,76],[78,50]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:5, name:'CounterOF', label:'Counter OF', cat:'run',
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[96,96],[110,80],[126,54]), c:CLR.run,w:2.8,a:true},
      {d:CB([88,FB_Y],[96,90],[116,74],[132,56]), c:CLR.block,w:1.8,a:true},
      {d:CB([70,LOS],[76,LOS+8],[96,LOS+2],[106,LOS-8]), c:CLR.pull,w:1.8,a:true},
      {d:P([80,LOS],[80,LOS-9]),   c:CLR.block,w:1.2,a:true},
      {d:P([90,LOS],[90,LOS-9]),   c:CLR.block,w:1.2,a:true},
      {d:P([100,LOS],[102,LOS-7]), c:CLR.block,w:1.2,a:true},
      {d:P([110,LOS],[114,LOS-6]), c:CLR.block,w:1.2,a:true},
    ],
  },
  {
    id:6, name:'TossLead', label:'Toss Lead', cat:'run',
    sk:[...I_RIGHT],
    rt:[
      {d:QQ([88,QB_Y],[116,92],[142,88]), c:CLR.toss,w:1.5,a:true,dsh:true},
      {d:CB([88,RB_Y],[110,98],[138,72],[156,42]), c:CLR.run,w:2.8,a:true},
      {d:CB([88,FB_Y],[104,92],[134,74],[150,48]), c:CLR.block,w:1.8,a:true},
  ...
  {
    id:7, name:'Draw', label:'Draw', cat:'run',
    sk:[...PRO_RIGHT],
    rt:[
  ...
  },
  {
    ...
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[84,96],[82,76],[82,50]), c:CLR.run,w:2.8,a:true},
  ...
  },
  {
    ...
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[100,98],[122,76],[144,48]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:10, name:'FBLead', label:'FB Lead', cat:'run',
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,FB_Y],[88,88],[88,72],[88,48]), c:CLR.run,w:2.8,a:true},
      {d:P([88,RB_Y],[88,90]),                  c:CLR.block,w:1.6,a:true},
  ...
  },
  {
    ...
    rt:[
      ...
      {d:P([166,LOS],[160,LOS-8]), c:CLR.block,w:1,a:true},
      {d:P([180,LOS],[174,LOS-8]), c:CLR.block,w:1,a:true},
    ],
  },
  {
    ...
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[96,98],[114,78],[130,52]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:13, name:'JetSweep', label:'Jet Sweep', cat:'run',
    sk:[...PRO_RIGHT],
    rt:[
      {d:CB([12,LOS],[34,LOS+14],[68,LOS+16],[112,LOS+2]), c:CLR.motion,w:1.5,a:false,dsh:true},
      {d:P([88,QB_Y],[104,QB_Y-8]), c:CLR.toss,w:1.2,a:true,dsh:true},
      {d:CB([112,LOS+2],[132,64],[154,48],[176,34]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:14, name:'WRReverse', label:'WR Reverse', cat:'run',
    sk:[...PRO_RIGHT],
    rt:[
      {d:QQ([88,QB_Y],[116,92],[146,88]), c:CLR.toss,w:1.3,a:true,dsh:true},
      {d:CB([166,LOS],[154,44],[130,56],[104,68]), c:CLR.motion,w:1.4,a:false,dsh:true},
      {d:CB([104,68],[84,74],[52,60],[24,34]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:15, name:'GoalLineDive', label:'Goal Line Dive', cat:'run',
    sk:[...HEAVY_GOAL],
    rt:[
      {d:CB([88,RB_Y],[88,96],[88,78],[88,58]), c:CLR.run,w:2.8,a:true},
      ...
      {d:P([22,LOS],[22,LOS-9]),    c:CLR.block,w:1.4,a:true},
  ...
  /* ═══ PASS 16-40 ═════════════════════════════ */
  {
    id:16, name:'SlantFlat', label:'Slant/Flat', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:CB([12,LOS],[24,52],[40,48],[56,48]), c:CLR.pass,w:2.2,a:true},
  ...
  {
    id:17, name:'Stick', label:'Stick', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      ...
      {d:P([12,LOS],[12,28]),                  c:CLR.pass,w:1.5,a:true},
      {d:QQ([102,QB_Y+8],[118,82],[132,78]),   c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]),             c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:18, name:'Spacing', label:'Spacing', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:P([12,LOS],[12,46],[12,50]),          c:CLR.pass,w:1.8,a:true},
      {d:P([100,LOS],[100,48],[100,52]),       c:CLR.pass,w:1.8,a:true},
      {d:P([166,LOS],[166,50],[166,54]),       c:CLR.pass,w:1.8,a:true},
      {d:P([180,LOS],[180,26]),                c:CLR.pass,w:1.5,a:true},
      {d:QQ([102,QB_Y+8],[120,82],[138,80]),   c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]),             c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:19, name:'Hitches', label:'Hitches', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:P([12,LOS],[12,54],[12,58]),          c:CLR.pass,w:2.2,a:true},
      {d:P([166,LOS],[166,54],[166,58]),       c:CLR.pass,w:2.2,a:true},
      {d:P([180,LOS],[180,54],[180,58]),       c:CLR.pass,w:2.2,a:true},
      {d:P([100,LOS],[100,50],[100,54]),       c:CLR.pass,w:1.8,a:true},
      {d:QQ([102,QB_Y+8],[118,82],[132,80]),   c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]),             c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
  ...
  {
    id:21, name:'YOption', label:'Y Option', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:CB([100,LOS],[102,48],[116,40],[132,42]), c:CLR.pass,w:2.3,a:true},
      {d:CB([12,LOS],[26,52],[44,48],[58,48]),     c:CLR.pass,w:2,a:true},
      {d:P([166,LOS],[166,26]),                    c:CLR.pass,w:1.8,a:true},
      {d:P([180,LOS],[180,24]),                    c:CLR.pass,w:1.5,a:true},
      {d:QQ([102,QB_Y+8],[118,82],[130,78]),       c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]),                 c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:22, name:'Drive', label:'Drive', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
  ...
  },
  {
    ...
    sk:[...PRO_RIGHT],
    rt:[
      {d:P([12,LOS],[12,36],[92,36]),           c:CLR.pass,w:2.2,a:true},
      {d:CB([100,LOS],[120,58],[146,58],[176,58]), c:CLR.pass,w:2.2,a:true},
      {d:P([166,LOS],[166,24]),                 c:CLR.pass,w:1.8,a:true},
      {d:P([180,LOS],[180,44]),                 c:CLR.pass,w:1.6,a:true},
      {d:QQ([102,QB_Y+8],[118,82],[132,78]),    c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]),              c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:24, name:'Mesh', label:'Mesh', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:CB([12,LOS],[36,60],[80,58],[116,60]),   c:CLR.pass,w:2.2,a:true},
      {d:CB([166,LOS],[146,58],[108,56],[74,58]), c:CLR.pass,w:2.2,a:true},
  ...
  {
    id:25, name:'Dagger', label:'Dagger', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
  ...
  {
    id:26, name:'Sail', label:'Sail', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
  ...
  {
    id:27, name:'Flood', label:'Flood', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
  ...
  {
    id:28, name:'Hank', label:'Hank', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:P([12,LOS],[12,46],[12,50]),           c:CLR.pass,w:1.9,a:true},
      {d:P([100,LOS],[100,46],[100,50]),        c:CLR.pass,w:1.9,a:true},
      {d:P([166,LOS],[166,46],[166,50]),        c:CLR.pass,w:1.9,a:true},
      {d:P([180,LOS],[180,24]),                 c:CLR.pass,w:1.5,a:true},
      {d:QQ([102,QB_Y+8],[118,82],[132,80]),    c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]),              c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  ...
  {
    id:29, name:'CurlFlat', label:'Curl/Flat', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
  ...
  {
    id:30, name:'PostDig', label:'Post-Dig', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:CB([12,LOS],[12,34],[34,22],[56,18]),    c:CLR.pass,w:2.2,a:true},
      {d:P([166,LOS],[166,34],[118,34]),          c:CLR.pass,w:2.2,a:true},
      {d:P([180,LOS],[180,24]),                   c:CLR.pass,w:1.8,a:true},
      {d:P([100,LOS],[100,26]),                   c:CLR.pass,w:1.8,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]),               c:CLR.qbmove,w:1.5,a:false,dsh:true},
  ...
  {
    id:31, name:'PAPost', label:'PA Post', cat:'pass',
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[88,98],[94,92],[98,88]),    c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:P([88,FB_Y],[88,82]),                     c:CLR.protect,w:1.6,a:false},
      {d:CB([176,LOS],[176,34],[154,20],[132,16]),c:CLR.pass,w:2.5,a:true},
      {d:P([12,LOS],[12,28]),                      c:CLR.pass,w:1.8,a:true},
      {d:P([100,LOS],[100,26]),                    c:CLR.pass,w:1.8,a:true},
  ...
  {
    id:32, name:'PADeepCross', label:'PA Deep Cross', cat:'pass',
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[88,98],[94,92],[98,88]),    c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:P([88,FB_Y],[88,82]),                     c:CLR.protect,w:1.6,a:false},
      {d:CB([176,LOS],[160,44],[118,34],[76,34]), c:CLR.pass,w:2.5,a:true},
      {d:P([12,LOS],[12,24]),                      c:CLR.pass,w:1.8,a:true},
      {d:P([100,LOS],[100,26]),                    c:CLR.pass,w:1.8,a:true},
      {d:P([70,LOS],[70,LOS-9]),                   c:CLR.protect,w:1.2,a:false},
      {d:P([80,LOS],[80,LOS-9]),                   c:CLR.protect,w:1.2,a:false},
  ...
  {
    id:33, name:'PABoot', label:'PA Boot', cat:'pass',
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[88,98],[96,92],[108,88]),    c:CLR.qbmove,w:1.6,a:false,dsh:true},
      {d:CB([88,QB_Y],[108,92],[132,82],[150,72]),  c:CLR.qbmove,w:1.6,a:false,dsh:true},
      {d:QQ([100,LOS],[118,68],[140,66]),           c:CLR.pass,w:2.2,a:true},
      {d:P([176,LOS],[176,24]),                     c:CLR.pass,w:2.2,a:true},
      {d:CB([12,LOS],[12,38],[28,26],[44,22]),      c:CLR.pass,w:1.8,a:true},
      {d:P([70,LOS],[70,LOS-9]),                    c:CLR.protect,w:1.2,a:false},
      {d:P([80,LOS],[80,LOS-9]),                    c:CLR.protect,w:1.2,a:false},
      {d:P([90,LOS],[90,LOS-9]),                    c:CLR.protect,w:1.2,a:false},
      {d:P([100,LOS],[100,LOS-9]),                  c:CLR.protect,w:1.2,a:false},
  ...
  {
    id:34, name:'PACorner', label:'PA Corner', cat:'pass',
    sk:[...I_RIGHT],
    rt:[
      {d:CB([88,RB_Y],[88,98],[94,92],[98,88]),     c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:P([88,FB_Y],[88,82]),                      c:CLR.protect,w:1.6,a:false},
      {d:CB([100,LOS],[112,40],[130,24],[148,18]), c:CLR.pass,w:2.3,a:true},
  ...
  {
    id:36, name:'Yankee', label:'Yankee', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
  ...
  {
    id:37, name:'DoublePost', label:'Double Post', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
  ...
  {
    id:38, name:'SwitchVert', label:'Switch Vert', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:CB([166,LOS],[166,44],[182,36],[190,24]), c:CLR.pass,w:2.2,a:true},
      {d:CB([180,LOS],[180,54],[164,44],[156,24]), c:CLR.pass,w:1.8,a:true},
      {d:P([12,LOS],[12,24]),                      c:CLR.pass,w:2.2,a:true},
      {d:P([100,LOS],[100,26]),                    c:CLR.pass,w:1.8,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]),                c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:P([102,QB_Y+8],[102,QB_Y+2]),             c:CLR.protect,w:1.5,a:false},
    ],
  ...
  {
    id:39, name:'Wheel', label:'Wheel', cat:'pass',
    sk:[...SPLIT_BACKS],
    rt:[
      {d:CB([76,QB_Y+8],[70,QB_Y],[58,80],[44,40]), c:CLR.pass,w:2.2,a:true},
      {d:CB([100,QB_Y+8],[116,QB_Y],[138,78],[160,36]), c:CLR.pass,w:2.2,a:true},
  ...
  {
    id:40, name:'TESeam', label:'TE Seam', cat:'pass',
    sk:[...PRO_RIGHT],
    rt:[
      {d:P([100,LOS],[100,14]),                   c:CLR.pass,w:2.4,a:true},
      {d:P([12,LOS],[12,28]),                     c:CLR.pass,w:1.8,a:true},
      {d:P([166,LOS],[166,26]),                   c:CLR.pass,w:1.8,a:true},
      {d:P([180,LOS],[180,24]),                   c:CLR.pass,w:1.5,a:true},
      {d:QQ([102,QB_Y+8],[118,82],[132,78]),      c:CLR.pass,w:1,a:true,dsh:true},
...
const LEGENDS = {
  ...
  pass: [
    {c:CLR.pass,l:'Route'},
    {c:CLR.qbmove,l:'Drop/Play Action'},
...
/* ── APP ─────────────────────────────────────── */
export default function WestCoastPlaybook() {
  ...
  return (
    <div style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
          ...
          <div>
            ...
            <div style={{ color:'#a78bfa', fontSize:9, fontWeight:700, letterSpacing:'3px', opacity:0.8 }}>
              CLASSIC WALSH · RHYTHM · TIMING · BALANCE
            </div>
          </div>
      ...
      <div style={{
        ...
        WEST COAST SYSTEM · 40 PLAYS · TAP TO DETAIL
      </div>
