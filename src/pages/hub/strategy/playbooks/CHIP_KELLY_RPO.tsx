...
/* Chip Kelly: spread, shotgun, tempo */
const QB_Y = 88;
...
const PLAYS = [
  ...
  {
    id:2, name:'Split_Zone', label:'Split Zone', cat:'run',
    sk:[...TREY_RIGHT_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,82],[96,68],[96,50]), c:CLR.run,w:2.8,a:true},
      {d:CB([100,LOS],[88,72],[74,62],[58,56]),   c:CLR.block,w:1.6,a:true,dsh:true},
  ...
  {
    id:3, name:'Outside_Zone', label:'Outside Zone', cat:'run',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[112,84],[128,70],[154,52]), c:CLR.run,w:2.8,a:true},
  ...
  {
    id:11, name:'Bash', label:'Bash', cat:'run',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[112,84],[126,70],[144,52]), c:CLR.read,w:2.2,a:true,dsh:true},
      {d:CB([88,QB_Y],[88,82],[84,68],[82,50]),     c:CLR.run,w:2.8,a:true},
      {d:CB([70,LOS],[76,LOS+8],[96,LOS+2],[104,LOS-8]), c:CLR.pull,w:1.8,a:true},
      {d:P([80,LOS],[80,LOS-9]),   c:CLR.block,w:1.2,a:true},
      {d:P([90,LOS],[90,LOS-9]),   c:CLR.block,w:1.2,a:true},
      {d:P([100,LOS],[100,LOS-9]), c:CLR.block,w:1.2,a:true},
  ...
  {
    id:12, name:'Pin_Pull', label:'Pin-Pull', cat:'run',
    sk:[...DOUBLES_SKILL],
    rt:[
  ...
  {
    id:13, name:'Lead_Draw', label:'Lead Draw', cat:'run',
    sk:[
      {x:6,y:LOS,t:'WR'},{x:26,y:LOS,t:'WR'},
      {x:162,y:LOS,t:'WR'},{x:180,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:100,y:QB_Y,t:'RB'},{x:112,y:QB_Y,t:'FB'},
    ],
    rt:[
  ...
  {
    id:14, name:'Sweep_Read', label:'Sweep Read', cat:'run',
    sk:[...DOUBLES_SKILL],
    rt:[
  ...
  {
    id:15, name:'Counter_Read', label:'Counter Read', cat:'run',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,66],[94,50]), c:CLR.run,w:2.8,a:true},
      {d:CB([80,LOS],[86,LOS+8],[96,LOS+2],[100,LOS-8]), c:CLR.pull,w:1.8,a:true},
  ...
  {
    id:18, name:'OZ_Stick', label:'OZ Stick', cat:'rpo',
    sk:[...SLOT_RIGHT_SKILL],
    rt:[
      {d:CB([88,QB_Y],[96,82],[108,70],[122,54]), c:CLR.run,w:2,a:true,dsh:true},
  ...
  {
    id:19, name:'Duo_Slant', label:'Duo Slant', cat:'rpo',
    sk:[...DOUBLES_SKILL],
    rt:[
  ...
  {
    id:20, name:'Counter_Hitch', label:'Counter Hitch', cat:'rpo',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,66],[94,50]), c:CLR.run,w:2,a:true,dsh:true},
      {d:CB([80,LOS],[86,LOS+8],[96,LOS+2],[100,LOS-8]), c:CLR.pull,w:1.6,a:true,dsh:true},
  ...
  {
    id:21, name:'PowerRead_Bubble', label:'Power Read Bubble', cat:'rpo',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[104,82],[106,68],[106,52]), c:CLR.run,w:2,a:true,dsh:true},
      {d:CB([88,QB_Y],[80,84],[70,68],[68,52]), c:CLR.read,w:1.8,a:true,dsh:true},
      {d:QQ([162,LOS],[148,72],[136,78]), c:CLR.sit,w:2.2,a:true},
      {d:QQ([180,LOS],[166,72],[154,78]), c:CLR.sit,w:1.5,a:true},
  ...
  {
    id:22, name:'Glance_Seam', label:'Glance Seam', cat:'rpo',
    sk:[...SLOT_RIGHT_SKILL],
    rt:[
      {d:CB([88,QB_Y],[86,80],[84,68],[82,52]), c:CLR.run,w:2,a:true,dsh:true},
      {d:CB([162,LOS],[156,52],[142,48],[126,48]), c:CLR.pass,w:2.2,a:true},
  ...
  {
    id:23, name:'SlotFade_RPO', label:'Slot Fade RPO', cat:'rpo',
    sk:[...SLOT_RIGHT_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,68],[92,52]), c:CLR.run,w:2,a:true,dsh:true},
  ...
  {
    id:24, name:'Choice_RPO', label:'Choice RPO', cat:'rpo',
    sk:[...SLOT_RIGHT_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,68],[92,52]), c:CLR.run,w:2,a:true,dsh:true},
      {d:QQ([100,LOS],[118,60],[132,58]), c:CLR.pass,w:2.2,a:true},
      {d:P([162,LOS],[162,42]), c:CLR.pass,w:1.8,a:true},
      {d:P([180,LOS],[180,24]), c:CLR.pass,w:1.5,a:true},
      {d:P([88,QB_Y],[104,QB_Y-8]), c:CLR.read,w:1.5,a:true,dsh:true},
    ],
  },
  {
    id:25, name:'Smash_RPO', label:'Smash RPO', cat:'rpo',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,68],[94,52]), c:CLR.run,w:2,a:true,dsh:true},
  ...
  {
    id:26, name:'Curl_RPO', label:'Curl RPO', cat:'rpo',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,68],[94,52]), c:CLR.run,w:2,a:true,dsh:true},
      {d:P([162,LOS],[162,28],[162,32]), c:CLR.pass,w:2.2,a:true},
      {d:QQ([180,LOS],[170,60],[160,62]), c:CLR.pass,w:2,a:true},
      {d:P([26,LOS],[26,50]), c:CLR.pass,w:1.5,a:true},
      {d:P([88,QB_Y],[102,QB_Y-8]), c:CLR.read,w:1.5,a:true,dsh:true},
    ],
  },
  {
    id:27, name:'SpeedOut_RPO', label:'Speed Out RPO', cat:'rpo',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,68],[94,52]), c:CLR.run,w:2,a:true,dsh:true},
      {d:P([162,LOS],[162,22],[182,22]), c:CLR.pass,w:2.2,a:true},
      {d:P([180,LOS],[180,24]), c:CLR.pass,w:1.5,a:true},
      {d:P([6,LOS],[6,26]),     c:CLR.pass,w:1.5,a:true},
      {d:P([88,QB_Y],[102,QB_Y-8]), c:CLR.read,w:1.5,a:true,dsh:true},
    ],
  ...
  {
    id:28, name:'Pop_Pass', label:'Pop Pass', cat:'rpo',
    sk:[...SLOT_RIGHT_SKILL],
    rt:[
      {d:CB([88,QB_Y],[86,80],[84,68],[82,52]), c:CLR.run,w:2,a:true,dsh:true},
      {d:P([100,LOS],[100,36]), c:CLR.pass,w:2.2,a:true},
  ...
  {
    id:29, name:'Screen_RPO', label:'Screen RPO', cat:'rpo',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,68],[94,52]), c:CLR.run,w:2,a:true,dsh:true},
      {d:CB([26,LOS],[30,70],[34,78],[36,82]), c:CLR.sit,w:2.2,a:true},
      {d:CB([88,QB_Y],[62,86],[46,84],[36,82]), c:CLR.sit,w:1.8,a:true,dsh:true},
      {d:CB([6,LOS],[12,68],[24,74],[30,78]),   c:CLR.block,w:1.5,a:true},
      {d:P([88,QB_Y],[102,QB_Y-8]), c:CLR.read,w:1.5,a:true,dsh:true},
    ],
  },
  {
    id:30, name:'Texas_RPO', label:'Texas RPO', cat:'rpo',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:CB([102,QB_Y],[100,80],[96,68],[94,52]), c:CLR.run,w:2,a:true,dsh:true},
      {d:CB([102,QB_Y],[110,78],[100,66],[90,60]), c:CLR.pass,w:2.2,a:true},
      {d:P([162,LOS],[162,26]), c:CLR.pass,w:1.8,a:true},
      {d:P([180,LOS],[180,26]), c:CLR.pass,w:1.8,a:true},
      {d:P([88,QB_Y],[102,QB_Y-8]), c:CLR.read,w:1.5,a:true,dsh:true},
    ],
  ...
  /* ═══ PASS 31-35 ═════════════════════════════ */
  {
    id:31, name:'Four_Verts', label:'4 Verts', cat:'pass',
    sk:[...DOUBLES_SKILL],
    rt:[
  ...
  },
  {
    ...
    rt:[
      {d:CB([182,LOS],[192,40],[178,20],[162,18]), c:CLR.pass,w:2.2,a:true},
      {d:P([166,LOS],[166,50],[196,50]),           c:CLR.pass,w:2.2,a:true},
      {d:QQ([148,LOS],[164,64],[182,62]),          c:CLR.pass,w:2,a:true},
  ...
  /* ═══ SCREENS 36-40 ══════════════════════════ */
  {
    id:36, name:'Tunnel', label:'Tunnel', cat:'screen',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:P([88,QB_Y],[88,QB_Y+6]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([26,LOS],[30,70],[34,78],[36,82]), c:CLR.sit,w:2.2,a:true},
  ...
  {
    id:37, name:'Jailbreak', label:'Jailbreak', cat:'screen',
    sk:[...DOUBLES_SKILL],
    rt:[
  ...
  {
    id:38, name:'Slip', label:'Slip', cat:'screen',
    sk:[...TREY_RIGHT_SKILL],
    rt:[
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
  ...
  {
    id:39, name:'Bubble', label:'Bubble', cat:'screen',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:QQ([162,LOS],[148,72],[136,78]), c:CLR.sit,w:2.2,a:true},
      {d:QQ([180,LOS],[166,72],[154,78]), c:CLR.sit,w:1.5,a:true},
      {d:P([88,QB_Y],[102,QB_Y-6]),       c:CLR.sit,w:1.8,a:true,dsh:true},
      {d:P([6,LOS],[6,26]),               c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([26,LOS],[26,42]),             c:CLR.pass,w:1,a:true,dsh:true},
      {d:CB([102,QB_Y],[108,78],[118,74],[126,72]), c:CLR.block,w:1.2,a:true,dsh:true},
    ],
  },
  {
    id:40, name:'Swing', label:'Swing', cat:'screen',
    sk:[...DOUBLES_SKILL],
    rt:[
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
...
const CATS = [
  ...
  { id:'rpo',    label:'RPO (15)',   accent:'#fb923c' },
  { id:'pass',   label:'Pass (5)',   accent:'#a78bfa' },
  { id:'screen', label:'Screens (5)',accent:'#fbbf24' },
];

/* ── APP ─────────────────────────────────────── */
export default function ChipKellyRPOPlaybook() {
  ...
  return (
    <div style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
          ...
          <div>
            ...
            <div style={{ color:'#fb923c', fontSize:9, fontWeight:700, letterSpacing:'3px', opacity:0.8 }}>
              TEMPO · READS · CONFLICT DEFENDERS
            </div>
          </div>
      ...
      <div style={{
        ...
        CHIP KELLY RPO · 40 PLAYS · TAP TO DETAIL
      </div>
