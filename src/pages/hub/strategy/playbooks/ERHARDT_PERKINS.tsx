...
const PLAYS = [
  /* ═══ RUNS 1-10 ══════════════════════════════ */
  {
    ...
    sk:[
      {x:14,y:LOS,t:'WR'},{x:176,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:100,y:QB_Y,t:'RB'},
      {x:58,y:LOS,t:'TE'},
    ],
    rt:[
      {d:CB([100,QB_Y],[96,82],[90,68],[88,50]), c:CLR.run,w:2.8,a:true},
      ...
      {d:P([58,LOS],[54,LOS-8]), c:CLR.block,w:1.2,a:true},
  ...
  },
  {
    ...
    rt:[
      {d:CB([100,QB_Y],[102,82],[104,68],[104,52]), c:CLR.run,w:2.8,a:true},
      ...
      {d:P([14,LOS],[14,LOS-8]), c:CLR.block,w:1,a:true},
    ],
  },
  {
  ...
  },
  {
    ...
    rt:[
      ...
      {d:P([58,LOS],[70,LOS-6]), c:CLR.block,w:1.3,a:true},
  ...
  {
    id:7, name:'LeadWeak', label:'Lead Weak', cat:'run',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:176,y:LOS,t:'WR'},
      {x:58,y:LOS,t:'TE'},
      {x:96,y:QB_Y+3,t:'FB'},
    ...
    rt:[
      {d:CB([104,QB_Y],[98,82],[88,68],[76,52]), c:CLR.run,w:2.8,a:true},
      {d:CB([96,QB_Y+3],[90,78],[84,64],[78,52]), c:CLR.block,w:1.8,a:true},
      {d:P([58,LOS],[54,LOS-8]), c:CLR.block,w:1.2,a:true},
  ...
  },
  {
    ...
    rt:[
      {d:QQ([88,QB_Y],[124,QB_Y-4],[156,QB_Y-10]), c:CLR.toss,w:1.5,a:true,dsh:true},
      {d:CB([156,QB_Y-10],[172,54],[184,40],[192,30]), c:CLR.run,w:2.8,a:true},
      {d:P([58,LOS],[70,LOS-6]), c:CLR.block,w:1.3,a:true},
  ...
  },
  {
    ...
    rt:[
      {d:CB([104,QB_Y],[100,80],[96,68],[94,50]), c:CLR.run,w:2.8,a:true},
      {d:CB([96,QB_Y+3],[94,76],[92,64],[92,50]), c:CLR.block,w:1.8,a:true},
      {d:P([58,LOS],[58,LOS-9]), c:CLR.block,w:1.3,a:true},
  ...
  /* ═══ PASS 11-30 ═════════════════════════════ */
  {
    ...
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ],
    rt:[
      {d:P([14,LOS],[14,26]), c:CLR.pass,w:1.8,a:true},
      {d:QQ([58,LOS],[74,58],[90,56]), c:CLR.read,w:2.2,a:true,dsh:true},
      {d:CB([166,LOS],[166,50],[148,42],[132,42]), c:CLR.pass,w:2.2,a:true},
      {d:P([182,LOS],[182,22]), c:CLR.pass,w:1.6,a:true},
      {d:QQ([102,QB_Y],[116,80],[128,76]), c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    ...
    rt:[
      {d:P([58,LOS],[58,16]), c:CLR.read,w:2.4,a:true,dsh:true},
      {d:P([166,LOS],[166,16]), c:CLR.pass,w:2.2,a:true},
      {d:CB([182,LOS],[182,38],[168,26],[152,22]), c:CLR.pass,w:2,a:true},
      {d:P([14,LOS],[14,26]), c:CLR.pass,w:1.6,a:true},
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:13, name:'DeepPost', label:'Deep Post', cat:'pass',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  },
  {
    ...
    rt:[
      {d:P([14,LOS],[14,32],[90,32]), c:CLR.pass,w:2.2,a:true},
      {d:CB([58,LOS],[58,46],[80,32],[98,26]), c:CLR.pass,w:2.2,a:true},
      {d:CB([182,LOS],[182,32],[150,22],[124,20]), c:CLR.pass,w:2,a:true},
  ...
  },
  {
    ...
    rt:[
      ...
      {d:CB([14,LOS],[10,42],[24,26],[38,20]), c:CLR.pass,w:2,a:true},
      {d:CB([182,LOS],[186,42],[172,26],[158,20]), c:CLR.pass,w:2,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
  ...
  {
    id:19, name:'DigPost', label:'Dig-Post', cat:'pass',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
    ...
    rt:[
      ...
      {d:CB([14,LOS],[14,36],[32,24],[52,18]), c:CLR.pass,w:2.2,a:true},
  ...
  {
    id:20, name:'CrossCountry', label:'Cross Country', cat:'pass',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  },
  {
    ...
    rt:[
      ...
      {d:QQ([102,QB_Y],[116,80],[126,78]), c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
  ...
  {
    id:23, name:'FourVerts', label:'4 Verts', cat:'pass',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      ...
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([102,QB_Y],[110,80],[120,74],[128,70]), c:CLR.pass,w:1,a:true,dsh:true},
    ],
  },
  {
  ...
  {
    id:25, name:'DoubleIn', label:'Double In', cat:'pass',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
    ...
    rt:[
      {d:P([14,LOS],[14,32],[44,32]), c:CLR.pass,w:2.2,a:true},
      {d:P([58,LOS],[58,34],[88,34]), c:CLR.pass,w:2.2,a:true},
      {d:P([166,LOS],[166,34],[136,34]), c:CLR.pass,w:2.2,a:true},
      {d:P([182,LOS],[182,32],[152,32]), c:CLR.pass,w:2.2,a:true},
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    id:26, name:'WheelSeam', label:'Wheel Seam', cat:'pass',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},{x:102,y:QB_Y,t:'RB'},
    ...
    rt:[
      {d:CB([102,QB_Y],[110,88],[126,68],[140,30]), c:CLR.pass,w:2.2,a:true},
      {d:P([58,LOS],[58,16]), c:CLR.pass,w:2.2,a:true},
  ...
  {
    id:27, name:'SlotFade', label:'Slot Fade', cat:'pass',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
  ...
  {
    id:29, name:'StickNod', label:'Stick Nod', cat:'pass',
    sk:[
      {x:14,y:LOS,t:'WR'},{x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
      {x:88,y:QB_Y,t:'QB'},
    ...
    rt:[
      {d:CB([58,LOS],[58,58],[66,46],[76,20]), c:CLR.read,w:2.2,a:true,dsh:true},
      {d:P([166,LOS],[166,54],[166,58]), c:CLR.pass,w:2.2,a:true},
      {d:P([182,LOS],[182,26]), c:CLR.pass,w:1.8,a:true},
      {d:P([14,LOS],[14,26]), c:CLR.pass,w:1.5,a:true},
      {d:P([88,QB_Y],[88,QB_Y+8]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
  ...
  /* ═══ PLAY ACTION 31-35 ══════════════════════ */
  {
    ...
    rt:[
      ...
      {d:P([166,LOS],[166,30]), c:CLR.pa,w:1.6,a:true},
  ...
  },
  {
    ...
    rt:[
      {d:CB([102,QB_Y],[98,84],[94,76],[92,70]), c:CLR.run,w:2,a:true,dsh:true},
      {d:P([58,LOS],[58,18]), c:CLR.pa,w:2.2,a:true},
      {d:P([166,LOS],[166,18]), c:CLR.pa,w:2.2,a:true},
      {d:CB([14,LOS],[10,42],[24,26],[38,20]), c:CLR.pa,w:2,a:true},
      {d:CB([182,LOS],[186,42],[172,26],[158,20]), c:CLR.pa,w:2,a:true},
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
    ],
  },
  {
    ...
    rt:[
      {d:CB([100,QB_Y],[96,84],[92,76],[90,70]), c:CLR.run,w:2,a:true,dsh:true},
  ...
  /* ═══ SCREENS 36-40 ══════════════════════════ */
  {
    id:36, name:'RB_Screen', label:'RB Screen', cat:'screen',
    sk:[
      {x:14,y:LOS,t:'WR'},
      {x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
    ...
    rt:[
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([104,QB_Y],[124,QB_Y],[150,76],[170,70]), c:CLR.screen,w:2.2,a:true},
      {d:CB([88,QB_Y+10],[120,QB_Y+6],[150,76],[170,70]), c:CLR.screen,w:1.8,a:true,dsh:true},
      {d:CB([100,LOS],[108,66],[126,64],[142,66]), c:CLR.block,w:1.5,a:true},
      {d:CB([110,LOS],[118,68],[136,66],[152,68]), c:CLR.block,w:1.5,a:true},
      {d:P([182,LOS],[182,24]), c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([14,LOS],[14,24]), c:CLR.pass,w:1,a:true,dsh:true},
    ],
  },
  {
    id:37, name:'SlowScreen', label:'Slow Screen', cat:'screen',
    sk:[
      {x:14,y:LOS,t:'WR'},
      {x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
    ...
    rt:[
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([104,QB_Y],[106,QB_Y+6],[102,QB_Y+10],[92,QB_Y+14]), c:CLR.screen,w:2,a:true},
      {d:CB([92,QB_Y+14],[90,78],[88,64],[88,50]), c:CLR.screen,w:2.2,a:true},
  ...
  {
    id:38, name:'Tunnel', label:'Tunnel', cat:'screen',
    sk:[
      {x:14,y:LOS,t:'WR'},
      {x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
    ...
    rt:[
      ...
      {d:CB([166,LOS],[170,70],[174,78],[176,82]), c:CLR.screen,w:2.2,a:true},
      {d:CB([88,QB_Y+6],[118,86],[148,84],[176,82]), c:CLR.screen,w:1.8,a:true,dsh:true},
      {d:CB([182,LOS],[178,68],[174,74],[170,78]), c:CLR.block,w:1.5,a:true},
      {d:CB([110,LOS],[128,64],[148,60],[164,62]), c:CLR.block,w:1.5,a:true},
      {d:P([14,LOS],[14,26]), c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([58,LOS],[58,26]), c:CLR.pass,w:1,a:true,dsh:true},
    ],
  },
  {
    id:39, name:'Jailbreak', label:'Jailbreak', cat:'screen',
    sk:[
      {x:14,y:LOS,t:'WR'},
      {x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
    ...
    rt:[
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([102,QB_Y],[126,QB_Y],[152,80],[176,74]), c:CLR.screen,w:2.2,a:true},
      {d:CB([88,QB_Y+10],[126,QB_Y+6],[154,80],[176,74]), c:CLR.screen,w:1.8,a:true,dsh:true},
      {d:CB([166,LOS],[168,70],[172,72],[176,74]), c:CLR.block,w:1.5,a:true},
      {d:CB([182,LOS],[180,68],[178,72],[176,74]), c:CLR.block,w:1.5,a:true},
      {d:P([14,LOS],[14,24]), c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([58,LOS],[58,24]), c:CLR.pass,w:1,a:true,dsh:true},
    ],
  },
  {
    id:40, name:'TE_Screen', label:'TE Screen', cat:'screen',
    sk:[
      {x:14,y:LOS,t:'WR'},
      {x:58,y:LOS,t:'TE'},
      {x:166,y:LOS,t:'WR'},{x:182,y:LOS,t:'WR'},
    ...
    rt:[
      {d:P([88,QB_Y],[88,QB_Y+10]), c:CLR.qbmove,w:1.5,a:false,dsh:true},
      {d:CB([58,LOS],[60,66],[64,74],[68,78]), c:CLR.screen,w:2.2,a:true},
      {d:CB([88,QB_Y+10],[80,84],[74,80],[68,78]), c:CLR.screen,w:1.8,a:true,dsh:true},
      {d:CB([70,LOS],[78,66],[88,64],[96,66]), c:CLR.block,w:1.5,a:true},
      {d:CB([80,LOS],[90,68],[102,66],[112,68]), c:CLR.block,w:1.5,a:true},
      {d:P([14,LOS],[14,24]), c:CLR.pass,w:1,a:true,dsh:true},
      {d:P([182,LOS],[182,24]), c:CLR.pass,w:1,a:true,dsh:true},
    ],
  },
...
/* ── LEGENDS ─────────────────────────────────── */
const LEGENDS = {
  run:    [{c:CLR.run,l:'Ball Carrier'},{c:CLR.pull,l:'Pull'},{c:CLR.toss,l:'Pitch'},{c:CLR.block,l:'Block'}],
  pass:   [{c:CLR.pass,l:'Route'},{c:CLR.read,l:'Option/Read'},{c:CLR.qbmove,l:'Drop'}],
  pa:     [{c:CLR.run,l:'Run Fake'},{c:CLR.pa,l:'PA Route'},{c:CLR.protect,l:'Protection'},{c:CLR.qbmove,l:'Set'}],
  screen: [{c:CLR.screen,l:'Screen Path'},{c:CLR.block,l:'Escort'},{c:CLR.qbmove,l:'Set'}],
};
...
/* ── APP ─────────────────────────────────────── */
export default function VerticalErhardtPerkinsPlaybook() {
  ...
  return (
    <div style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
          ...
          <div>
            ...
            <div style={{ color:'#a78bfa', fontSize:9, fontWeight:700, letterSpacing:'3px', opacity:0.8 }}>
              VERTICAL STRESS · OPTION ROUTES · PLAY-ACTION
            </div>
          </div>
      ...
      <div style={{
        ...
        VERTICAL ERHARDT-PERKINS · 40 PLAYS · TAP TO DETAIL
      </div>
