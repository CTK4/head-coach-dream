...
export const HUB_CARD =
  "rounded-xl border border-slate-300/20 bg-slate-950/65 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_10px_24px_rgba(0,0,0,0.45)]";
export const HUB_DIVIDER = "h-px w-full bg-gradient-to-r from-transparent via-amber-300/60 to-transparent";
export const HUB_TEXT_GOLD = "text-amber-300";
export const HUB_BUTTON =
  "rounded-md border border-blue-200/30 bg-gradient-to-b from-blue-700/70 to-blue-950/90 text-slate-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.25)] hover:brightness-110";
export const HUB_PILL =
  "px-2 py-0.5 text-[10px] rounded-full border border-slate-200/30 bg-slate-800/70 uppercase tracking-wide text-slate-100";

export const hubTheme = {
  pageBackground: HUB_BG,
  pageTexture: HUB_TEXTURE,
  pageVignette: HUB_VIGNETTE,
  frame: HUB_FRAME,
  metallicDivider: HUB_DIVIDER,
  goldText: HUB_TEXT_GOLD,
